  ...
  return (
    <>
      ...
      <div className="bg-white dark:bg-gray-900 dark:text-gray-100">
        <div className="container mx-auto space-y-16 px-8 py-16 lg:px-[80px] lg:py-32 xl:max-w-7xl">
          {/* Heading */}
          <div className="text-center">
            <div className="mb-1 text-sm font-bold tracking-wider text-emerald-600 uppercase dark:text-emerald-500">
              We Answer
            </div>
