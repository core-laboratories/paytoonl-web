    ...
    <footer className="bg-white">
      <div className="pb-16 pt-4 sm:pt-10 lg:pt-12 container mx-auto px-4 sm:px-6 lg:px-0">
        <div>
          ...
          <div className="grid grid-cols-2 gap-12 border-t border-gray-200 pt-10 md:grid-cols-4 lg:grid-cols-6 lg:gap-8 lg:pt-12">
            ...
            <div>
              ...
              <nav className="flex flex-col gap-2"><div>
                ...
                <div>
                  <a
                    href="https://www.postman.com/core-labs/workspace/oric/collection/13185637-5e66eeab-546b-4928-9a7f-b4f9f006c191"
                    target="_blank"
                    rel="noopener"
                    className="text-gray-500 transition duration-100 hover:text-indigo-500 active:text-indigo-600"
                  >
            ...
            <div>
              ...
              <nav className="flex flex-col gap-2">
                ...
                <div>
                  <a
                    href="mailto:alliance@payto.onl"
                    className="text-gray-500 transition duration-100 hover:text-indigo-500 active:text-indigo-600"
                  >
                    Alliance Members
                  </a>
        ...
        <div className="container mx-auto max-w-screen-2xl px-4 md:px-0">
          <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-4 py-8">
            <span className="text-sm text-gray-400">
              ...
              >
                <span className="text-xl">⊛</span> CORE 2025-{new Date().getFullYear()}
              </a>{" "}
              PayTo Alliance
            </span>
            ...
            <div className="flex gap-4">
              ...
              >
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path d="M.003 12.016 5.347 1h15.324l-1.714 3.295-11.356.001-3.916 7.721-1.58.002 1.58.002 3.916 7.722h11.356l1.714 3.295H5.347L.003 12.022H0l.001-.003L0 12.016h.003Zm23.995.002-5.041-7.722-1.975 3.862h-6.525l-1.985 3.859h-.001v.004h.001l1.985 3.859h6.525l1.975 3.862 5.041-7.722H24l-.001-.001.001-.001h-.002Z"/>
                </svg>
              </a>
              ...
              >
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                    <path d="M310.2 80h.05l-8.253 20h20l8.253-20h-.05l8.253-20h-20L310.2 80Zm89.053-50c0 16.55-13.45 30-30 30h-30.8l8.5-20h22.3c5.5 0 10-4.5 10-10s-4.5-10-10-10h-13.8l8.3-20h5.5c16.55 0 30 13.45 30 30Zm-72.75 10h-20l-8.253 20h20l8.253-20ZM340.63 0h-20l-8.253 20h20l8.253-20Z" transform="matrix(.23717 0 0 .23717 -70.737 .141)"/>
                  </svg>
              </a>
            </div>
          </div>
