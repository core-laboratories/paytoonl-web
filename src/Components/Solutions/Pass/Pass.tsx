      ...
      <section className="container mx-auto flex flex-col px-4 gap-6 sm:gap-10 md:gap-16 lg:px-0">
        <div className="container mx-auto flex flex-col lg:flex-row justify-between gap-6 sm:gap-10 md:gap-16">
          ...
          <div className="h-48 overflow-hidden rounded-lg bg-gray-100 shadow-lg lg:h-auto xl:w-5/12">
            <img
              src="https://plus.unsplash.com/premium_photo-1671308540287-3f59130cfa31?q=80&w=3087&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              loading="lazy"
          ...
          <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
            <div className="mb-10 md:mb-16">
              <h2 className="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">
                Why Use Pass for Payment Requests?
              </h2>
            ...
            <div className="grid gap-4 sm:grid-cols-2 md:gap-8 xl:grid-cols-2">
              <div className="flex divide-x rounded-lg border bg-gray-50">
                ...
                <div className="p-4 md:p-6">
                  ...
                  <ul className="list-disc text-gray-500 pl-5">
                    <li>
                      Instead of exposing sensitive payment details like IBAN,
                      UPI, or BIC, the PKPASS file encapsulates payment
                      instructions securely.
                    </li>
                    <li>
                      Reduces the risk of fraud, phishing, and unauthorized
                      access.
                    </li>
                  </ul>
                </div>
              ...
              <div className="flex divide-x rounded-lg border bg-gray-50">
                ...
                <div className="p-4 md:p-6">
                  ...
                  <ul className="list-disc text-gray-500 pl-5">
                    <li>
                      PKPASS files are natively supported by Apple Wallet and
                      Google Wallet, making it easy to import and initiate
                      payments directly from a mobile device.
                    </li>
                    <li>
                      Transactions become contactless and digital, eliminating
                      the need for paper invoices or manual bank transfers.
                    </li>
                  </ul>
                </div>
              </div>
              <div className="flex divide-x rounded-lg border bg-gray-50">
                ...
                <div className="p-4 md:p-6">
                  ...
                  <ul className="list-disc text-gray-500 pl-5">
                    <li>
                      PKPASS files support multiple payment methods such as
                      ICAN, IBAN, ACH, PIX, UPI, BIC, and more.
                    </li>
                    <li>
                      They can be customized with QR codes, barcodes, or NFC
                      triggers for easier processing.
                    </li>
                  </ul>
                </div>
              </div>
              <div className="flex divide-x rounded-lg border bg-gray-50">
                ...
                <div className="p-4 md:p-6">
                  ...
                  <ul className=" list-disc text-gray-500 pl-5">
                    <li>
                      Businesses can generate and send a PKPASS payment request
                      to customers who simply import it into their wallets and
                      approve the payment.
                    </li>
                    <li>
                      Ideal for invoices, online orders, or peer-to-peer
                      transfers.
                    </li>
                  </ul>
                </div>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:gap-12">
              <div>
                <div className="h-64 overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-auto">
                  <img
                    src="https://images.unsplash.com/photo-1537498425277-c283d32ef9db?q=80&w=2956&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    loading="lazy"
              ...
              <div>
                ...
                <h1 className="mb-4 text-center text-2xl font-bold text-gray-800 sm:text-3xl md:mb-6 md:text-left">
                  PKPASS in Google Wallet & Apple Wallet
                </h1>
                ...
                <div>
                  <p className="text-gray-500">
                    ...
                    <b>PKPASS-based payment requests.</b> Once imported, the
                    pass can contain:
                  </p>
                  <ul className="list-disc text-gray-500 pl-5">
                  ...
                  <p className="text-gray-500 mt-4">
                    ...
                    <b>
                      built-in encryption and biometric authentication (Face ID,
                      Touch ID, PIN) to safeguard transactions.
                    </b>{" "}
                    Users can review the details{" "}
