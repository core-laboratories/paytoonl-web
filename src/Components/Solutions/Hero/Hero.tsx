  ...
  return (
    <section className="min-h-96 relative flex flex-1 shrink-0 items-center justify-center overflow-hidden bg-gray-100 py-16 shadow-lg md:py-20 xl:py-48">
      ...
      <div className="relative flex flex-col items-center p-4 sm:max-w-xl">
        ...
        <p className="mb-4 text-center text-lg text-green-200 sm:text-xl md:mb-8">The Alliance is supporting payment tools that will ease payment instructions and extend the possibilities of modern payments.</p>
      </div>
    </section>
  );
}
